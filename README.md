...
- The third section, following an underscore, points to an entry in the [KSDC BibTeX file](https://github.com/langdoc/sjd/meta/KSDC.bib), which contains bibliographical information on the original source of texts originating from printed publications.
...
The [Speakers overview](meta/sessions.md) provides a list of non-anonymised speakers in the corpus and links to their Wikidata-entries. The [KSDC BibTeX file](https://github.com/langdoc/sjd/meta/KSDC.bib) includes all printed sources. 
